...
base1 = communicator.stringToProxy("SimplePrinter1:tcp -h 172.31.22.194 -p 11000")
base2 = communicator.stringToProxy("SimplePrinter2:tcp -h 172.31.22.194 -p 11000")
